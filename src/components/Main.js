        ...
        <Container>
          <Row className="justify-content-center">
            <div className="col-lg-6 text-center">
              <h1 className="fw-light">«Encrypt notes» — это сервис шифровки коротких заметок</h1>
            </div>
          </Row>
          <Row className="justify-content-center py-4">
          <Col className="text-center py-3 py-md-0" md={4}>
            <Button className="fw-light" variant="outline-dark" size="lg">
            <NavLink to="/create">Создать шифрованную заметку</NavLink>
            </Button>
          </Col>
          <Col className="text-center" md={4}>
            <Button className="fw-light" variant="outline-light" size="lg">
            <NavLink to="/note">Расшифровать заметку</NavLink>
            </Button>
          </Col>
        </Row>
        </Container>

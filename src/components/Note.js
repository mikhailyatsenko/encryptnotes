      ...
      <Container>
        <Row className="justify-content-center">
          ...
          <div className={noteClass + " text-center"}>
            ...
            <div className="mb-4 col-md-6 alert alert-info mx-auto"><strong>"{noteText}"</strong></div>
            <Button className="fw-light" variant="outline-dark" onClick={() => {window.location.href = env.url}}>Расшифровать еще одну заметку</Button>
          </div>
          <div className={errorClass + " col-md-8 text-center"}>
            ...
            <Button className="fw-light" variant="outline-dark" onClick={() => {window.location.href = env.url}}>Попробовать снова</Button>
          </div>
